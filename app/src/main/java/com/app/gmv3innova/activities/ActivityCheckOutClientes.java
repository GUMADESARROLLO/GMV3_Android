...
import com.app.gmv3innova.adapters.AdapterCheckOutClientes;
import com.app.gmv3innova.models.Clients;
...
import static com.app.gmv3innova.utilities.Constant.GET_CLIENTS;

public class ActivityCheckOutClientes extends AppCompatActivity implements AdapterCheckOutClientes.ContactsAdapterListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_checkout_clientes);
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        if (Utils.isNetworkAvailable(ActivityCheckOutClientes.this)) {
    ...
    public void onContactSelected(Clients cls) {
        final Intent intent = new Intent(ActivityCheckOutClientes.this, ActivityCheckout.class);
        ...
        try {
            if (cls.getMOROSO().equals("S")){
                ...
                new AlertDialog.Builder( this)
                        .setTitle("Alerta!")
                        .setMessage("Pedido Exede el limite Disponible, ¿Desea Continua?")
                        .setCancelable(false)
