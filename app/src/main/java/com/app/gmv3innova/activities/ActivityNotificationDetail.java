...
import static com.app.gmv3innova.utilities.Constant.GET_PRODUCT_ID;
import static com.app.gmv3innova.utilities.Constant.GET_TAX_CURRENCY;
...
public class ActivityNotificationDetail extends AppCompatActivity {
    ...
    private String product_name, product_image, category_name, product_status, currency_code, product_description,product_bonificado;
        ...
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.GET, GET_PRODUCT_ID + product_id, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    product_bonificado = response.getString("product_bonificado");
                ...
                if (!temp.equalsIgnoreCase("")) {
                    ...
                    if (quantity <= 0) {
                       ...
                       /* if (dbhelper.isDataExist(product_id)) {
                        ...
                        dbhelper.addData(product_id, product_name, quantity, (product_price * quantity), currency_code, product_image,product_bonificado);
                    }
